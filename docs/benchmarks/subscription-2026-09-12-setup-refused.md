...
Status: **refused**. 72/148 planned arm executions completed.
...
Refusal: `setup_cleanup_failed_before_dispatch`. Unexecuted rows remain planned in the JSON; they were not silently dropped.
